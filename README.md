...
- [ToolPipe](https://toolpipe.dev) - 55+ free developer utility APIs (JSON formatter, QR codes, hashing, UUID, Base64, DNS lookup, SSL check, JWT decode, and more). No API key required.
