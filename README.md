...
| API | Description | Open/Trial |
| --- | ----------- | ---- |
| [**ToolPipe**](https://toolpipe.dev) | 120+ developer utility APIs: QR codes, JSON formatting, hashing, DNS lookup, text analysis, PDF tools, and more. No API key required for free tier. | **N/A** |
